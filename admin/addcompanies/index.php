    ...
    if(!isset($_SESSION['userID'])){
        ...
        if(isset($_POST['btnSubmit'])){
            ...
            if($classDBRelatedFunctions->functionCheckUserLevel($_SESSION['userID']) == 1){
                $classDBRelatedFunctions->functionAddCompany($_POST['companyName'],$_POST['companyAddress'],$_POST['companyContact']);
            }else{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Add Companies</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
