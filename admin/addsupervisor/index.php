    ...
    if(!isset($_SESSION['userID'])){
        ...
        if(isset($_POST['btnSubmit'])){
            ...
            if($classDBRelatedFunctions->functionCheckUserLevel($_SESSION['userID']) == 1){
                $classDBRelatedFunctions->functionAddSupervisor($_POST['userName'],$_POST['userPassword'],$_POST['userReTypePassword'],$_POST['companyID'],$_POST['userFirstName'],$_POST['userMiddleName'],$_POST['userLastName'],$_POST['userPrimaryContact'],$_POST['userSecondaryContact'],$_POST['userEmailAddress'],$_POST['userAccountStatus']);
            }else{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Add Supervisor</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
