<?php
    ...
    if(isset($_POST['btnEditInfoSetter'])){
         ...
         *
         */
        $_SESSION['sessionCompanyEditorActivation'] = $_POST['sessionCompanyEditorActivation'];
        $_SESSION['sessionEditCompanyID'] = $_POST['sessionEditCompanyID'];
        $_SESSION['sessionEditCompanyName'] = $_POST['sessionEditCompanyName'];
        $_SESSION['sessionEditCompanyAddress'] = $_POST['sessionEditCompanyAddress'];
        $_SESSION['sessionEditCompanyContact'] = $_POST['sessionEditCompanyContact'];

        if(isset($_POST['sessionCompanyEditorActivation']) and $_POST['sessionCompanyEditorActivation'] == 1){
            header("Location: ../editcompanies");
        }
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        require_once("../include/DBConfigs.php");
                                        $classDBRelatedFunctions->functionCompanyListX();
                                    ?>
                                    </tbody>
                                </table>
                            </div>
