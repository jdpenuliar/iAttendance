<?php
    ...
    if(!isset($_SESSION['userID'])){
        ...
        if(!isset($_SESSION['sessionSupervisorEditorActivation'])){
            header("Location: ../supervisor");
        }
        if(isset($_POST['btnSubmit'])){
            if($classDBRelatedFunctions->functionCheckUserLevel($_SESSION['userID']) == 1){
                if(empty($_POST['userName']) or !isset($_POST['userName']) or $_POST['userName'] == "" or $_POST['userName'] == " "){
                    $updatedSupervisorUserName = $_SESSION['sessionEditSupervisorUserName'];
                }else{
                    $updatedSupervisorUserName = $_POST['userName'];
                }
                ...
                if((empty($_POST['userPassword']) or !isset($_POST['userPassword']) or $_POST['userPassword'] == "" or $_POST['userPassword'] == " ")
                    ...
                    $updatedSupervisorUserPassword = null;
                    $updatedSupervisorUserReTypePassword = null;
                }else{
                    $updatedSupervisorUserPassword = $_POST['userPassword'];
                    $updatedSupervisorUserReTypePassword = $_POST['userReTypePassword'];
                }

                if(empty($_POST['userCompanyID']) or !isset($_POST['userCompanyID']) or $_POST['userCompanyID'] == "" or $_POST['userCompanyID'] == " "){
                    $updatedSupervisorUserCopmanyID = $_SESSION['sessionEditSupervisorUserCompanyID'];
                }else{
                    $updatedSupervisorUserCopmanyID = $_POST['userCompanyID'];
                }

                if(empty($_POST['userFirstName']) or !isset($_POST['userFirstName']) or $_POST['userFirstName'] == "" or $_POST['userFirstName'] == " "){
                    $updatedSupervisorUserFirstName = $_SESSION['sessionEditSupervisorUserFirstName'];
                }else{
                    $updatedSupervisorUserFirstName = $_POST['userFirstName'];
                }

                if(empty($_POST['userMiddleName']) or !isset($_POST['userMiddleName']) or $_POST['userMiddleName'] == "" or $_POST['userMiddleName'] == " "){
                    $updatedSupervisorUserMiddleName = $_SESSION['sessionEditSupervisorUserMiddleName'];
                }else{
                    $updatedSupervisorUserMiddleName = $_POST['userMiddleName'];
                }

                if(empty($_POST['userLastName']) or !isset($_POST['userLastName']) or $_POST['userLastName'] == "" or $_POST['userLastName'] == " "){
                    $updatedSupervisorUserLastName = $_SESSION['sessionEditSupervisorUserLastName'];
                }else{
                    $updatedSupervisorUserLastName = $_POST['userLastName'];
                }
                ...
                if(empty($_POST['userPrimaryContact']) or !isset($_POST['userPrimaryContact']) or $_POST['userPrimaryContact'] == "" or $_POST['userPrimaryContact'] == " "){
                    $updatedSupervisorUserPrimaryContact = $_SESSION['sessionEditSupervisorUserPrimaryContact'];
                }else{
                    $updatedSupervisorUserPrimaryContact = $_POST['userPrimaryContact'];
                }
                ...
                if(empty($_POST['userSecondaryContact']) or !isset($_POST['userSecondaryContact']) or $_POST['userSecondaryContact'] == "" or $_POST['userSecondaryContact'] == " "){
                    $updatedSupervisorUserSecondaryContact = $_SESSION['sessionEditSupervisorUserSecondaryContact'];
                }else{
                    $updatedSupervisorUserSecondaryContact = $_POST['userSecondaryContact'];
                }

                if(empty($_POST['userEmailAddress']) or !isset($_POST['userEmailAddress']) or $_POST['userEmailAddress'] == "" or $_POST['userEmailAddress'] == " "){
                    $updateSupervisorUserEmailAddress = $_SESSION['sessionEditSupervisorUserEmailAddress'];
                }else{
                    $updatedSupervisorUserEmailAddress = $_POST['userEmailAddress'];
                }

                if(empty($_POST['userAccountStatus']) or !isset($_POST['userAccountStatus']) or $_POST['userAccountStatus'] == "" or $_POST['userAccountStatus'] == " "){
                    $updatedSupervisorUserAcountStatus = $_SESSION['sessionEditSupervisorUserAccountStatus'];
                }else{
                    $updatedSupervisorUserAcountStatus = $_POST['userAccountStatus'];
                }
                $updatedSupervisorUserID = $_SESSION['sessionEditSupervisorUserID'];
                $classDBRelatedFunctions->functionEditSupervisor($updatedSupervisorUserID,$updatedSupervisorUserName,$updatedSupervisorUserPassword,$updatedSupervisorUserReTypePassword,$updatedSupervisorUserCopmanyID,$updatedSupervisorUserFirstName,$updatedSupervisorUserMiddleName,$updatedSupervisorUserLastName,$updatedSupervisorUserPrimaryContact,$updatedSupervisorUserSecondaryContact,$updatedSupervisorUserEmailAddress,$updatedSupervisorUserAcountStatus);
                header("Location: ../supervisor");
            }else{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Supervisor<small>Do not fill the input if you will not change that particular information</small></h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Update user ID <?php echo $_SESSION['sessionEditSupervisorUserID']?> information
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Username: <?php echo $_SESSION['sessionEditSupervisorUserName']?></label>
                                        ...
                                        <div class="form-group">
                                            <label>User company: <?php
                                                require_once("../include/DBConfigs.php");
                                                echo $classDBRelatedFunctions->functionCompanyListEditX($_SESSION['sessionEditSupervisorUserCompanyID']);
                                                ?></label>
                                        ...
                                        <div class="form-group">
                                            <label>User account status: <?php
                                                if($_SESSION['sessionEditSupervisorUserAccountStatus'] == 1){
                                                    echo "Active";
                                                }else{
                                                    echo "Inactive";
                                                }
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>First name: <?php echo $_SESSION['sessionEditSupervisorUserName']?></label>
                                            <input class="form-control" placeholder="First name" tabindex="6" name="userFirstName" >
                                        </div>
                                        <div class="form-group">
                                            <label>Middle name: <?php echo $_SESSION['sessionEditSupervisorUserMiddleName']?></label>
                                            <input class="form-control" placeholder="Middle name" tabindex="7" name="userMiddleName" >
                                        </div>
                                        <div class="form-group">
                                            <label>Last name: <?php echo $_SESSION['sessionEditSupervisorUserLastName']?></label>
                                            <input class="form-control" placeholder="Last name" tabindex="8" name="userLastName" >
                                        </div>
                                        <div class="form-group">
                                            <label>Primary contact: <?php echo $_SESSION['sessionEditSupervisorUserPrimaryContact']?></label>
                                        ...
                                        <div class="form-group">
                                            <label>Secondary contact: <?php echo $_SESSION['sessionEditSupervisorUserSecondaryContact']?></label>
                                        ...
                                        <div class="form-group">
                                            <label>Email Address: <?php echo $_SESSION['sessionEditSupervisorUserEmailAddress']?></label>
