<?php
    ...
    if(isset($_POST['btnEditInfoSetter'])){
         ...
         *
         */
        $_SESSION['sessionInternEditorActivation'] = $_POST['sessionInternEditorActivation'];
        $_SESSION['sessionEditInternUserID'] = $_POST['sessionEditInternUserID'];
        $_SESSION['sessionEditInternUserName'] = $_POST['sessionEditInternUserName'];
        $_SESSION['sessionEditInternUserFirstName'] = $_POST['sessionEditInternUserFirstName'];
        $_SESSION['sessionEditInternUserMiddleName'] = $_POST['sessionEditInternUserMiddleName'];
        $_SESSION['sessionEditInternUserLastName'] = $_POST['sessionEditInternUserLastName'];
        $_SESSION['sessionEditInternUserCompanyID'] = $_POST['sessionEditInternUserCompanyID'];
        $_SESSION['sessionEditInternUserPrimaryContact'] = $_POST['sessionEditInternUserPrimaryContact'];
        $_SESSION['sessionEditInternUserSecondaryContact'] = $_POST['sessionEditInternUserSecondaryContact'];
        $_SESSION['sessionEditInternUserEmailAddress'] = $_POST['sessionEditInternUserEmailAddress'];
        $_SESSION['sessionEditInternUserAccountStatus'] = $_POST['sessionEditInternUserAccountStatus'];
        if(isset($_POST['sessionInternEditorActivation']) and $_POST['sessionInternEditorActivation'] == 1){
    ...
    if(isset($_POST['btnViewWeeklyReportSetter'])){
        
        $_SESSION['sessionViewWeeklyReportActivation'] = $_POST['sessionViewWeeklyReportActivation'];
        $_SESSION['sessionViewWeeklyReportUserID'] = $_POST['sessionViewWeeklyReportUserID'];
        if(isset($_POST['sessionViewWeeklyReportActivation']) and $_POST['sessionViewWeeklyReportActivation'] == 1){
            header("Location: ../weeklyreport");
        }

    }else{
        unset($_SESSION['sessionViewWeeklyReportActivation']);
    }
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        require_once("../include/DBConfigs.php");
                                        $classDBRelatedFunctions->functionInternList($_SESSION['userID']);
                                    ?>
                                    </tbody>
                                </table>
                            </div>
