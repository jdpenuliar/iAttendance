...
function processx(userID,startDate,endDate){
	...
	if((xmlHttp.readyState == 4)/*completed*/ || (xmlHttp.readyState == 0)/*uninitialized*/){
		try{
			...
			console.log(startDate + "-" + endDate + ":" +"datax.php?userID="+userID+"&startDate="+startDate+"&endDate="+endDate);
			
			console.log("../php/datax.php?userID="+userID+"&startDate="+startDate+" 00:00:00"+"&endDate="+endDate+" 23:59:00");
			xmlHttp.open("GET","../php/datax.php?userID="+userID+"&startDate="+startDate+" 00:00:00"+"&endDate="+endDate+" 23:59:00",true);
...
function handleResponse(){
	...
	userTotalWeekTime = root.getElementsByTagName("userTotalWeekTime");
	...
	*/
	...
	document.getElementById("modalUserTotalWeekTime").innerHTML = "Total time in the week: " + userTotalWeekTime.item(0).firstChild.data;
