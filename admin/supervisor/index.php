<?php
    ...
    if(isset($_POST['btnEditInfoSetter'])){
         ...
         *
         */
        $_SESSION['sessionSupervisorEditorActivation'] = $_POST['sessionSupervisorEditorActivation'];
        $_SESSION['sessionEditSupervisorUserID'] = $_POST['sessionEditSupervisorUserID'];
        $_SESSION['sessionEditSupervisorUserName'] = $_POST['sessionEditSupervisorUserName'];
        $_SESSION['sessionEditSupervisorUserFirstName'] = $_POST['sessionEditSupervisorUserFirstName'];
        $_SESSION['sessionEditSupervisorUserMiddleName'] = $_POST['sessionEditSupervisorUserMiddleName'];
        $_SESSION['sessionEditSupervisorUserLastName'] = $_POST['sessionEditSupervisorUserLastName'];
        $_SESSION['sessionEditSupervisorUserCompanyID'] = $_POST['sessionEditSupervisorUserCompanyID'];
        $_SESSION['sessionEditSupervisorUserPrimaryContact'] = $_POST['sessionEditSupervisorUserPrimaryContact'];
        $_SESSION['sessionEditSupervisorUserSecondaryContact'] = $_POST['sessionEditSupervisorUserSecondaryContact'];
        $_SESSION['sessionEditSupervisorUserEmailAddress'] = $_POST['sessionEditSupervisorUserEmailAddress'];
        $_SESSION['sessionEditSupervisorUserAccountStatus'] = $_POST['sessionEditSupervisorUserAccountStatus'];
        if(isset($_POST['sessionSupervisorEditorActivation']) and $_POST['sessionSupervisorEditorActivation'] == 1){
            header("Location: ../editsupervisor");
        }
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Supervisors</h1>
                </div>
                <!-- end  page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                        require_once("../include/DBConfigs.php");
                                        $classDBRelatedFunctions->functionSupervisorList($_SESSION['userID']);
                                    ?>
                                    </tbody>
                                </table>
                            </div>
