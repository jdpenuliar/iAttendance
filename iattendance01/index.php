<?php
	session_start();
	require_once("./admin/include/DBConfigs.php");
	...
	if(isset($_POST['GITM'])){
		...
		if($userLevelCompare < 3 and $userLevelCompare >= 0){
			header("Location: ./admin");
								...
								<?php
									...
									echo '
										<form role="form" action="./" method="post" class="registration-form">
											...
											<div class="form-group">
												<button type="submit" class="btn btn-block" name="GITM">Give it to me!</button>
											</div>
										</form>
									';
								?>
